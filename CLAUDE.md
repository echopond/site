...
- `.watch-finished` is a full-width band; its side padding (`--gutter`) keeps its contents on the same 1000px column as the other sections. Its heading is centered at Chris's request.
